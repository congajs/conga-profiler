...
export default Vue.extend({
        ...
        <div>
            ...
            <box v-if="responseData.error"> 
                <span slot="body">
                    ...
                    <pre v-if="responseData.error.data.stack">{{ responseData.error.data.stack }}</pre>
                    <pre v-else>{{ serializedResponseError }}</pre>
    ...
    computed: {
        ...
        originalError: function() {
            return this.request.response.error.data.originalError;
        },
        serializedResponseError() {
            return JSON.stringify(this.request.response.error, null, 4);
        }
    },
