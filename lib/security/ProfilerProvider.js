...
/**
 * The ProfilerProvider provides an auth resource for authentication / access into the profiler backend dashboard
 */
class ProfilerProvider extends AbstractProvider {
    ...
    _getProvider() {
        ...
        if (profilerConfig instanceof Object &&
            ...
            let provider = this.container.get('security.firewall.provider.factory').getProviderFromConfig(customConfig);
            if (provider) {
